...
public class TableFieldFrontendTypeController {
    ...
    */
    ...
    @PostMapping("updateTableFieldFrontendTypeS")
    @Transactional
    public Result<?> updateTableFieldFrontendTypePojo(@RequestBody List<TableFieldFrontendTypePojo> tableFieldFrontendTypePojos) {
        Result<?> result = null;
        for (TableFieldFrontendTypePojo tableFieldFrontendTypePojo : tableFieldFrontendTypePojos) {
            result = tableFieldFrontendTypeService.updateTableFieldFrontendType(tableFieldFrontendTypePojo);
        }
        return result;
    }
